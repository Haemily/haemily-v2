...
function openWhatsApp(phone,name){
  ...
  const text=encodeURIComponent(`Hi ${name}, I saw your profile on Haemily and wanted to connect.`);
  window.open(`https://wa.me/65${digits}?text=${text}`,'_blank','noopener,noreferrer');
}
